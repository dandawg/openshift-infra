...
# This script deploys a CPU machineset via ArgoCD with proper Helm parameter configuration
...
case "$INSTANCE_TYPE" in
  "m6a.4xlarge")
    GITOPS_FILE="gitops/infra/cpu-machineset-aws-m6a-4xlarge.yaml"
    APP_NAME="cpu-machineset-aws-m6a-4xlarge"
    MACHINE_NAME_SUFFIX="m6a-4x"
    ;;
  *)
    echo "Error: Unsupported INSTANCE_TYPE '$INSTANCE_TYPE'"
    echo "Supported types: m6a.4xlarge"
    echo "To add support for other instance types, update this script and create corresponding GitOps manifests."
    exit 1
    ;;
esac

echo "==================================="
echo "CPU MachineSet Deployment"
echo "==================================="
